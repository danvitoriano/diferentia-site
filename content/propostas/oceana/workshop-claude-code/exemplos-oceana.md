...
## Analistas de investimento / quant
...
- Fluxo de triagem documental repetível no terminal
- Templates versionados com histórico de alterações
...
- Automação de apoio a formulários e triagem de comunicações (com etapa de revisão humana)
