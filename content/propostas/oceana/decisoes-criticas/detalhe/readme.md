...
| Material | Descrição |
|---|---|
| [exemplos-oceana.md](exemplos-oceana.md) | Prompts, system prompts e casos de uso adaptados para a Oceana |

---

## Como usar este repositório

Cada `sessao-XX-*.md` segue o padrão da trilha:

- Mapa de blocos com timing
- Roteiro para o facilitador
- Seção **O que NÃO entra nesta sessão**
- Exercício com resultado esperado
