...
|---|---|---|---|
| 1 | Demo ao vivo — impacto antes da teoria | 0:00 – 0:20 | nenhum |
| 2 | IA, LLMs, reativa vs. agentes, API e MCP | 0:20 – 0:35 | Capa, Anthropic, IA Reativa, Glossário |
| 3 | Primeiros Passos — conta, interface, configurações | 0:35 – 0:55 | Seção 1 (Primeiros Passos) |
| 4 | Intervalo | 0:55 – 1:05 | — |
| 5 | Prompts e casos de uso | 1:05 – 1:45 | Seção 2 (Fundamentos de Prompt) + Seção 3 (Casos de Uso) |
| 6 | Exercício prático e encerramento | 1:45 – 2:00 | — |

---

## BLOCO 1: Demo ao vivo (0:00 – 0:20)
...
## BLOCO 2: IA, LLMs, reativa vs. agentes, API e MCP (0:20 – 0:35)
...
**[0:20 – 0:23] Anthropic e o Claude**
...
**[0:27 – 0:32] IA reativa vs. agentes**
...
**[0:32 – 0:35] Glossário e encerramento do bloco**
...
## BLOCO 3: Primeiros Passos — conta, interface, configurações (0:35 – 0:55)
...
**[0:35 – 0:38] Criando conta e planos**
...
**[0:38 – 0:43] Interface geral e histórico**
...
**[0:43 – 0:47] Modelos e configurações**
...
## BLOCO 5: Fundamentos de Prompt e Casos de Uso (1:05 – 1:45)
...
**[1:05 – 1:12] O que é um prompt e por que importa**
...
**[1:12 – 1:20] A arquitetura do prompt perfeito**
...
**[1:20 – 1:32] Casos de uso ao vivo**
...
**[1:32 – 1:38] Limitações importantes**
...
**[1:38 – 1:45] Pausa para perguntas**

> "Antes do exercício final: alguma dúvida sobre prompts ou casos de uso?"

---

## BLOCO 6: Exercício prático e encerramento (1:45 – 2:00)
