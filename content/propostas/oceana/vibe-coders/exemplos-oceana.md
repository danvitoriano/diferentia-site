...
## Módulo 3: substituir o projeto de demonstração

### Analistas de investimento

**Caso: painel de releases**

Em vez de construir um site genérico, o participante constrói um painel
HTML simples que recebe texto de um release de resultados e exibe
os indicadores financeiros em cards visuais.
...
**Caso: checklist de due diligence**
...
**Caso: gerador de resposta a formulário de investidor**
...
## Módulo 4: substituir o exemplo de iteração e publicação

### Analistas de investimento

**Caso: evoluir o painel com comparação de trimestres**
...
**Caso: evoluir o conciliador com histórico de divergências**
...
**Caso: evoluir o checklist com vencimento de documentos**
...
> documentos que vencem nos próximos 30 dias. Use localStorage para
> persistir os dados.

### Variante: Comercial

**Caso: publicar o gerador de respostas na Vercel**
